...
[**Main Menu Credits**](https://modrinth.com/mod/main-menu-credits) mod. This
option can be enabled via the `MMC` tab.
...
Here's an example for adding a new entry:

<ModAsset width="100%" title="MMC Example" location="mutils:mmc_example" />

<ModAsset width="50%" title="MMC Example Preview" location="mutils:mmc_example_preview" />
