...
Let's start with a simple setup for your modpack that is hosted on **Modrinth**.

This is the default config screen.

<ModAsset width="100%" title="ModpackUtils Config" location="mutils:mutils_config" />
...
<Callout variant="info">
  Tip! You can check what other options do by looking at the tooltip in the
...
If your modpack is hosted on any platform other than **Modrinth**, you can use the `Custom` option in the `Platform` setting.
This option also supports Packwiz!
...
Now, you should be all set! If you still have any questions or if something goes wrong, you can ask for help on our [Discord server](https://discord.gg/kfKjjhv3pn).
